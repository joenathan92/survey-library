            ...
            <input type=hidden name=test value="hello">
                <div style="text-align: center;">
                    <h1>Pilih Jenis Layanan Dibawah Ini</h1>
                        ...
                        <input type="image" name="layanan"  class="avatar" src="img/menus/lec_emp.png" value="A-1" >
                        <input type=hidden name=test value="hello">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="image" class="avatar" name="layanan" src="img/menus/college_student.png" value="A-2"><br>
                </div>
        </form>
    </body>
</html>